...
export async function POST(request: NextRequest) {
  try {
    ...
    const { partDescription, application, segment, make, model, yearStart, yearEnd, condition, contributorName, contributorEmail, notes, partId } = body;
    ...
    const result = await sql`
      INSERT INTO scan_queue (contributor_id, part_id, part_description, application, segment, make, model, year_start, year_end, condition, notes)
      VALUES (${contributorId}, ${partId || null}, ${partDescription}, ${application}, ${segment || null}, ${make || null}, ${model || null}, ${yearStart || null}, ${yearEnd || null}, ${condition || null}, ${notes || null})
      RETURNING *
    `;
