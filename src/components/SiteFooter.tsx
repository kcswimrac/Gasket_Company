      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          <div className="col-span-2 lg:col-span-1">
            ...
            <p className="text-xs text-charcoal-300 leading-relaxed max-w-xs">
          ...
          <div>
            <h4 className="text-[10px] font-semibold uppercase tracking-[0.2em] text-charcoal-300 mb-4">Services</h4>
            <ul className="space-y-2.5">
              {[
                ...
                <li key={href}>
                  <a href={href} className="text-xs text-charcoal-300 hover:text-emerald-400 transition-colors">{label}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            <h4 className="text-[10px] font-semibold uppercase tracking-[0.2em] text-charcoal-300 mb-4">Contact</h4>
            <ul className="space-y-2.5 text-xs text-charcoal-300">
              ...
              <li className="text-charcoal-400">Mon–Fri, 7 AM – 5 PM CT</li>
            </ul>
          </div>

          <div>
            <h4 className="text-[10px] font-semibold uppercase tracking-[0.2em] text-charcoal-300 mb-4">Turnaround</h4>
            <ul className="space-y-2.5 text-xs text-charcoal-300">
