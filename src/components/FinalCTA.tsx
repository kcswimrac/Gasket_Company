  ...
  return (
    <section className="py-24 md:py-32 metal-texture relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto px-5 sm:px-6 lg:px-8 text-center relative z-10">
        <span className="inline-flex items-center px-4 py-1.5 rounded-full text-[11px] font-semibold bg-gold-500/6 text-gold-400/80 border border-gold-500/12 mb-8 uppercase tracking-wider">
          Rush turnaround and next-day shipping on qualifying orders
        </span>

        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold leading-tight">
          <span className="text-white">Need a Gasket?</span>
          <br />
          <span className="text-gold-gradient">Start Here.</span>
        </h2>

        <p className="mt-7 text-charcoal-400 max-w-lg mx-auto text-base sm:text-lg leading-relaxed">
          Upload your DXF or photo, specify your requirements, and receive a
